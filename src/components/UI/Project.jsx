const project = [
    ...
    },
    {
        ...
        description: 'This is a simple application using javascript, jquery, html, css and bootstrap to pull from the openweather api and display the current weather and the 5 day forecast for a city. The search history is also displayed.',
    ...
    },
    {
        ...
        description: 'This is a command-line application that prompts the user for input using the inquirer package. The user input is used to fill a markdown file template.',
        image: '/assets/readme.PNG',
        githubLink: 'https://github.com/bluethreadmade/README-generator',
        deployedLink: 'https://drive.google.com/file/d/19bVGJE_fgBrTlYVI0GxK5dFw36oWCkke/preview',
    },
    {
        title: 'Dad Dinner',
